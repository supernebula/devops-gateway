pipeline {
    ...
    stages {
        ...
        stage('Pull Config'){
            steps{
                sh "wget -N http://192.168.2.40:9080/kubernetes-group/devops-gateway/-/raw/main/Dockerfile"
                sh "wget -N http://192.168.2.40:9080/kubernetes-group/devops-gateway/-/raw/main/deployment.yaml"
                sh "wget -N http://192.168.2.40:9080/kubernetes-group/devops-gateway/-/raw/main/entrypoint.sh"
                sh "wget -N http://192.168.2.40:9080/kubernetes-group/devops-gateway/-/raw/main/settings.xml"
                sh "wget -N http://192.168.2.40:9080/kubernetes-group/devops-gateway/-/raw/main/stop-java.sh"
                sh "wget -N http://192.168.2.40:9080/kubernetes-group/devops-gateway/-/raw/main/svc.yaml"
                sh "wget -N http://192.168.2.40:9080/kubernetes-group/devops-gateway/-/raw/main/configmap.yaml"
